...
$(KERNEL_CONFIG): $(KERNEL_OUT)
	$(hide) if [ "$(FEATURE_NUBIA_USE_DIFF_CONFIG)" == "true" ];then \
	       ./$(TARGET_KERNEL_SOURCE)/creat_defconfig.sh $(KERNEL_ARCH) $(TARGET_PRODUCT) $(QCOM_DEFCONFIG) $(KERNEL_DEFCONFIG) $(PRODUCT_DIFF_CONFIG) $(TARGET_KERNEL_SOURCE); fi
...
kernelconfig: $(KERNEL_OUT) $(KERNEL_CONFIG)
	...
	$(hide) if [ "$(FEATURE_NUBIA_USE_DIFF_CONFIG)" == "true" ];then \
		./$(TARGET_KERNEL_SOURCE)/update_diff.sh $(KERNEL_ARCH) $(TARGET_PRODUCT) $(QCOM_DEFCONFIG) $(KERNEL_DEFCONFIG) $(PRODUCT_DIFF_CONFIG) $(TARGET_KERNEL_SOURCE); fi
